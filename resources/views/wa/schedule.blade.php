    ...
    <div class="card mb-4">
        <div class="card-body d-flex justify-content-between align-items-center">
            ...
            <form id="filter-form" action="{{ route('schedule-message.index') }}" method="GET" class="d-flex align-items-center">
                ...
                <select name="filter_status" id="filter_status" class="form-control form-control-sm" onchange="this.form.submit()">
                ...
                <tbody style="font-family: 'Verdana', sans-serif; font-size: 12px;">
                    ...
                    @forelse ($scheduledMessages as $message)
                        <tr style="border-bottom: 1px dashed #ddd;">
                            ...
                            <td class="text-justify text-uppercase" style="color: #007bff;">{{ $message->schedule_type }}</td>
                            <td class="text-justify" style="color: #333;">{{ $message->number }}</td>
                            <td class="text-justify" style="color: #555; font-style: italic;">{{ $message->message ?? 'N/A' }}</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="text-center text-danger fw-bold" style="font-family: 'Courier New', monospace; font-size: 14px;">No scheduled messages found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
